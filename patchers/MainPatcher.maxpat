...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 854.370364785194397, 281.0, 100.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 1031.685173392295837, 281.0, 58.0, 23.0 ],
					"sig" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 960.596194207668304, 391.0, 161.177958369255066, 22.0 ],
					"text" : "filtercoeff~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 537.888893187046051, 281.0, 100.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 715.203701794147491, 281.0, 58.0, 23.0 ],
					"sig" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 644.114722609519958, 391.0, 161.177958369255066, 22.0 ],
					"text" : "filtercoeff~"
				}
...
,
					"patching_rect" : [ 466.292680978775024, 808.268292188644409, 110.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 682.292680978775024, 808.268292188644409, 123.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 812.292680978775024, 815.268292188644409, 290.0, 34.0 ],
...
,
					"patching_rect" : [ 492.292680978775024, 845.268292188644409, 58.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 13.0,
...
, 			{
				"box" : 				{
					...
					"numpoints" : 512,
					"outlettype" : [ "" ],
					"patching_rect" : [ 472.292680978775024, 880.268292188644409, 483.0, 273.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 394.0, 357.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 520.0, 391.0, 105.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 394.0, 391.0, 110.0, 22.0 ],
					"text" : "prepend delayTaps"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 91.0, 151.0, 213.0 ],
					"text" : "TODO\n\n- Setup a filter on the delay line for the ikarplus strong\n\n- Setup a better ADSR without sustain.\n\n- Pitch control from midi controller, midi note to key and midi CC modwheel to pitch bend\n\n- Setup a reverb"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 344.5, 72.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 286.5, 391.0, 89.0, 22.0 ],
					"text" : "prepend ADSR"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 286.5, 481.888888597488403, 993.196483492851257, 22.0 ],
					"text" : "gen~ KarplusStrongAlgor @title KarplusStrongAlgor"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 337.833333333333371, 301.0, 40.0, 22.0 ],
					"text" : "line"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 277.5, 72.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 277.5, 115.0, 69.0, 22.0 ],
					"text" : "metro 6000"
				}
...
, 			{
				"box" : 				{
					"addpoints" : [ 0.0, 0.0, 0, 5.319148936170213, 1.0, 0, 53.191489361702125, 0.2, 0, 138.297872340425528, 0.0, 0 ],
					"id" : "obj-1",
					"maxclass" : "function",
					"numinlets" : 1,
					"numoutlets" : 4,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 277.5, 167.0, 200.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 589.5, 535.0, 73.0, 20.0 ],
					"text" : "Safety First!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 286.5, 535.0, 297.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 482.5, 618.0, 55.0, 20.0 ],
					"text" : "Metering"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 448.25, 590.0, 33.0, 20.0 ],
					"text" : "Post"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 411.5, 590.0, 27.0, 20.0 ],
					"text" : "Pre"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 448.25, 618.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 411.5, 618.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
,
					"patching_rect" : [ 411.5, 655.0, 126.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 286.5, 825.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 286.5, 584.0, 123.0, 164.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 802.922237427627579, 231.851848185062408, 38.0, 40.0 ],
					"text" : "q"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 728.885200293457046, 231.851848185062408, 38.0, 40.0 ],
					"text" : "gain"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1119.403709025775925, 231.851848185062408, 38.0, 40.0 ],
					"text" : "q"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1045.366671891605392, 231.851848185062408, 38.0, 40.0 ],
					"text" : "gain"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 421.0, 758.0, 273.5, 758.0, 273.5, 578.0, 296.0, 578.0 ],
					"source" : [ "obj-88", 0 ]
				}
